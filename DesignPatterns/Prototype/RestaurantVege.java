...
public class RestaurantVege implements Cloneable{
	...
	@Override
	protected RestaurantVege clone() throws CloneNotSupportedException {
		// TODO Auto-generated method stub
		RestaurantVege shop = new RestaurantVege();
		
		for(Foods b : this.getFoods()) {
			shop.getFoods().add(b);
		}
		return shop;
	}
