...
public class HashFunction5 {
	...
	public int stringHashFunction(String wordToHash) {
		...
		for(int i = 0; i < wordToHash.length(); i++) {
			...
			int charCode = wordToHash.charAt(i)-96;//ex-a = 97-96
	...
	public static void main(String[] args) {
		...
		HashFunction5 wordHashTable = new HashFunction5(11);
...
class WordList{
	...
	public Word firstWord = null;//firstWord represents last word that entered
	...
	public void insert(Word newWord, int hashKey) {
		...
		if(previous == null) {//add very first word to the WordList
			firstWord = newWord;
		}else {
